...
export default class Order extends React.Component {
      ...
      toast(
        <div>
          <p>
            ...
            {(order.asset || order.assetBundle).name}
          </p>
          <a href="https://wallet.portis.io/collectibles" target="_blank">
            Check it out here
          </a>
        </div>
      );
  ...
  renderExpirationBadge() {
    ...
    const timeLeft = moment.duration(
      moment.unix(expirationTime).diff(moment())
    );
